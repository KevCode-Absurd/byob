...
function updateCode() {
    ...
    let selectedChatModel = document.getElementById("chatModel").value;
    // ...
    if (selectedChatModel) {
        let modelCode = codeOptions[selectedChatModel];
        // Update the chat model code with the selected temperature
        modelCode = modelCode.replace("()", `(temperature=${temperature})`);
        codeToDisplay += "\n" + modelCode;

        // codeToDisplay += "\n" + codeOptions[selectedChatModel];
    }
    // ...
